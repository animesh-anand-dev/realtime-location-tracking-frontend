...
const ImplementCustomHook = () => {
    const { location, error, refresh } = useGeoLocation();
    const mapContainerRef = useRef(location);
    ...
    return (
      <div id='mapdiv' ref={mapContainerRef} style={{ width: '100wh', height: '100vh' }} >
        {/* Your location is {location.latitude}, {location.longitude} */}
        {/* {console.log("Lat : " +location.latitude + "Lng : " + location.longitude + "Heading : " + location.heading)} */}
        <button onClick={refresh}>Refresh</button>
      </div>
    );
}

export default ImplementCustomHook